...
const timelineData = [
  {
    ...
    events: [
      { time: "10:00 AM", title: "Inauguration Ceremony", venue: "Shantai Auditorium", icon: <GraduationCap className="h-5 w-5 text-primary" /> },
      { time: "11:00 AM", title: "Briefing on Event Objectives", venue: "Shantai Auditorium", icon: <Presentation className="h-5 w-5 text-primary" /> },
      ...
      { time: "05:30 PM", title: "Hi-Tea & Networking", venue: "MCA Seminar Hall", icon: <Coffee className="h-5 w-5 text-primary" /> },
    ],
  },
  {
    day: "Day 2: Apex",
    ...
    events: [
      { time: "11:00 AM", title: "Top 20 Startups Announcement", venue: "Shantai Auditorium", icon: <Trophy className="h-5 w-5 text-primary" /> },
      { time: "11:00 AM", title: "Mentorship & Networking Session", venue: "Shantai Auditorium", icon: <Users className="h-5 w-5 text-primary" /> },
      { time: "12:00 PM", title: "Lunch Break", venue: "", icon: <Utensils className="h-5 w-5 text-primary" /> },
      { time: "01:30 PM", title: "Final Pitching by Top Startups", venue: "Shantai Auditorium", icon: <Mic className="h-5 w-5 text-primary" /> },
      { time: "04:00 PM", title: "Prize Distribution & Vote of Thanks", venue: "Shantai Auditorium", icon: <Award className="h-5 w-5 text-primary" /> },
      { time: "04:30 PM", title: "Concluding Hi-Tea", venue: "Shantai Auditorium", icon: <Coffee className="h-5 w-5 text-primary" /> },
    ],
  },
]
